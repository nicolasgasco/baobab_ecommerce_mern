  ...
  return (
    <div>
      ...
      <div role="alert" className="mx-auto  flex justify-center">
        <div className="z-40 absolute py-10 px-1 sm:px-5 md:px-10 bg-white shadow-md rounded border border-gray-400 w-11/12  lg:w-6/12 2xl:w-5/12">
          {/* X symbol */}
          ...
          <img
            src={src}
            alt={alt}
            className="w-full h-full shadow-md rounded-lg max-h-screen"
          />
        </div>
      </div>
    </div>
