...
const ShoppingCart = () => {
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-center bg-white py-12 px-4 sm:px-6 lg:px-8 my-12 md:mx-10 rounded-xl shadow-xl h-2/3">
                ...
                <table className="w-full text-sm lg:text-base" cellSpacing={0}>
                  <thead>
                    <tr className="h-12 uppercase">
                      ...
                      <th className="hidden text-right md:table-cell">Unit</th>
                ...
                <div className="justify-center md:flex">
                  <form action method="POST">
                    ...
                    <div className="p-4 bg-yellow-200 rounded-full">
                      <h2 className="ml-2 font-bold uppercase">
                        Shipping info
                      </h2>
                    </div>
